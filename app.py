...
vel_maquina = st.sidebar.number_input("Velocidad de Máquina (Picks/hora)", min_value=1000, max_value=20000, value=5000, step=500)
objetivo_horas = st.sidebar.number_input("Piso Inviolable Mínimo (Horas)", min_value=1.0, max_value=12.0, value=5.0, step=0.5)
adelanto_max_estandar = st.sidebar.number_input("Techo Máximo Configurable (Horas)", min_value=5.0, max_value=24.0, value=10.0, step=0.5)
...
demanda_lunes_siguiente = st.sidebar.number_input("Demanda Lunes Siguiente (Picks)", min_value=10000, max_value=200000, value=70000, step=5000)
...
# Validar que la suma del perfil horario no sea cero para evitar divisiones por cero
